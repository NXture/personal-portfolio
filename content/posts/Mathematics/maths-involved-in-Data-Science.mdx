---
title: "The Mathematics involved in Data Science"
date: 2021-08-20
...
The important thing to remember is that math forms the foundation of what we're going to do in Data Science. We've got maths and stats in the right corner if you see the Data Science Venn Diagram.

![Venn Diagram](./venn_diagram.jpg)

But for beginners or students, who just started their Data Science learning journey. The most important question is how much math is enough? Or to put it another way, why do
you need math at all, because you have got a computer to do it?

Well, I can think of three reasons why you don't want to rely on just a computer and it's helpful to have some sound mathematical understanding.

Here they are:

1. You need to know which procedures to use & why. 🤔

2. You need to know what to do when things don't work right. Sometimes you get impossible results. And it is good to know the mathematics that goes into calculating that so that you can understand how something apparently impossible can work. It helps to understand what it is about the algorithm that's happening, and why that won't work in that situation.
...
The idea here is that you can be a wonderful cook without knowing any chemistry, but if you know some chemistry, it will help. You can be a wonderful dancer without knowing kinesiology, but it is going to help. And you can probably be a good writer without having explicit knowledge of grammar, but it is going to make a big difference if you know some.
...
Well, there are few answers to that.
...
2. Some Calculus.
3. About Big O, which has to do with the order of a function, which has to do with how fast it works.
...
So, you can save yourself some time and some effort and move ahead more quickly toward your goal of insight.
